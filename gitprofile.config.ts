  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['metatemplate', 'RF-Signal-Classifier', 'nikdelgado.github.io', 'Sudoku_Solver_GUI'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
